...
| `.zero/components/<Name>.ts`          | One source file per component (17 total).                              |
| `.zero/components/<Name>.test.ts`     | One test file per component (17 total).                                |
...
| `.zero/styles/components/_<name>.scss`| One SCSS partial per component (17 total).                             |
