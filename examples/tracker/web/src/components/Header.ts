 ...
 * pad-md, gap-md) and tokens, not from a shipped component. The framework
 * does not ship a `Header` because brand and contents are inherently
 * app-specific; this is the worked example of building your own.
 *
 * @returns Template.
 */
  ...
  return html`
    <header class="app-header cluster split pad-md gap-md">
      <a class="app-header-brand cluster gap-sm" href="/">
        ${Logo()}
        <span class="app-header-title">tracker</span>
      </a>
      ${ThemeToggle()}
    </header>
  `;
